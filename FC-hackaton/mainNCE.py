...
if __name__ == "__main__":
    ...
    parser.add_argument('--loss', type=str, default='nce',help='ce, gce, sce, gcod, nce (default: ce)')
    ...
    parser.add_argument('--emb_dim', type=int, default=150, help='dimensionality of hidden units in GNNs (default: 300)') 
