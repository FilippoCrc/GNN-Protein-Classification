...
from src.loss_functions2 import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--loss', type=str, default='sce',help='ce, gce, sce, gcod (default: ce)')
    ...
    parser.add_argument('--gnn', type=str, default='gin-virtual', help='GNN gin, gin-virtual, or gcn, gcn-virtual (default: gin)')
    parser.add_argument('--drop_ratio', type=float, default=0.6, help='dropout ratio (default: 0.3)')
    ...
    parser.add_argument('--emb_dim', type=int, default=200, help='dimensionality of hidden units in GNNs (default: 300)') 
    ...
    parser.add_argument('--min_lr', type=float, default=1e-7, help='Minimum learning rate for schedulers (default: 1e-6)')
...
'''python main3.py --train_path "dataset/B/train.json.gz" --test_path "dataset/B/test.json.gz"
--loss "gce" --q 0.5 --emb_dim 150 --num_layer 5 --epochs 120 --batch_size 64 --lr 0.001''' 
